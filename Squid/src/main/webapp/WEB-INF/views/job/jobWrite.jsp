  ...
  <table class="table">
  	...
  	<tr>
		<th scope="row" style="width: 15%; vertical-align : middle; font-size: 18px;">제목</th>
  		<td colspan = "2"><input type = "text" name = "j_title" type="date" class="form-control" placeholder ="제목을 입력해주세요" ></td>
  	</tr>
    <tr>
    ...
    <tr>
		<th scope="row" style="width: 15%; vertical-align : middle;  font-size: 18px;">자기소개</th>
  		<td colspan = "2">
  			<textarea class="form-control" aria-label="With textarea" name = "j_intro" rows = "15" placeholder="자기소개서를 입력해주세요"></textarea>
  		</td>
  	</tr>
  	<tr>
  		<th scope="row" style="width: 15%; vertical-align : middle;  font-size: 18px;">파일첨부</th>
 		<td colspan = "2"><input type = "file" name = "j_pic" class="form-control"></td> 		
  	</tr>
</table>
	<div align="center">
