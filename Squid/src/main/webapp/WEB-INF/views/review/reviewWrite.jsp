		...
		<div class="row">
			<div class="card mt-4">
			   	<form action="review.reg" method="post">
			        ...
			        <button type="submit" class="btn btn-outline-warning mt-2 mb-4 regReviewBtn" name="token" value="${param.token }">등록하기</button>
			        <button type="button" class="btn btn-warning mt-2 mb-4 regReviewBtn" onclick="history.back()">목록으로</button>
			    </form>
		    </div>
    	</div>
    </div>
