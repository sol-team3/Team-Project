								...
								<div style="margin-left: 15px; width: 30px; height: 30px; border-radius: 70%; overflow: hidden; border: 1px solid #D1D1D1; display: inline-block;">
									...
									<ul class="dropdown-menu" >
										...
										<c:if test="${loginUser.u_type == '사업자' || loginUser.u_type == 'admin' }">
											<li><a class="dropdown-item" href="scrap_c.go?s_u_id=${loginUser.u_id }">마이 스크랩</a></li>
										</c:if>
										<c:if test="${loginUser.u_type == '개인' || loginUser.u_type == 'admin' }">
											<li><a class="dropdown-item" href="scrap.go?s_u_id=${loginUser.u_id }">마이 스크랩</a></li>
										</c:if>
      ...
      <div class="container">
         <div class="row">
            <div class="card-body col-md-6">
               ...
               <p class="card-text"> "오늘의 징검다리로 어우러지다"라는 의미로 아르바이트, 일용근로 형태의 구직자와 구인자의 징검다리가 되어주는 역할을 하는 서비스를 하고자 본 프로젝트를 구상했습니다.</p>
