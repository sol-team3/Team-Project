...
insert into chat values(chat_seq.nextval, 'admin', 'admin', 'junseok', '바보 ㅋ', sysdate);
insert into chat values(chat_seq.nextval, 'admin', 'junseok', 'admin', '야 ㅋㅋ', sysdate);
insert into chat values(chat_seq.nextval, 'solri', 'junseok', 'solri', '야 ㅋㅋ', sysdate);
insert into chat values(chat_seq.nextval, 'solri', 'solri', 'junseok', '야 ㅋㅋ', sysdate);
...
select distinct c_oppn from chat where c_toId = 'junseok' or c_fromId = 'junseok';
